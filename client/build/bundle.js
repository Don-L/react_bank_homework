...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SampleAccounts = __webpack_require__(160);
	...
	var BankBox = React.createClass({
	  ...
	  updateNotes: function updateNotes(account, note) {
	    var newAccs = [];
	  ...
	  addInterest: function addInterest() {
	    ...
	    this.setState({ accounts: newAccs });
	    this.getTotal(newAccs, 'Personal'), this.getTotal(newAccs, 'Business'), this.getTotal(newAccs);
	  },
	  ...
	  getTotal: function getTotal(accounts, string) {
	    var newTotal = 0;
	    if (!string) {
	  ...
	  filterAccounts: function filterAccounts(accounts, typeString) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var BankAccount = __webpack_require__(162);
	...
	var AccountBox = React.createClass({
	  ...
	  render: function render() {
	    var accComps = this.props.accounts.map(function (account) {
	      return React.createElement(BankAccount, {
	        key: account.owner,
	        data: account,
	    ...
	    return React.createElement(
	      'div',
	      { key: this.props.accounts[0].owner },
	      React.createElement(
	        'h2',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BankAccount = React.createClass({
	  ...
	  render: function render() {
	    var notesElement = React.createElement(
	      'p',
	      { onClick: this.notesClicked },
	      'CLICK TO ADD NOTES'
	    );
	    if (this.props.data.notes) {
	      notesElement = React.createElement(
	        'p',
	        { onClick: this.notesClicked },
	      ...
	      if (this.state.editNotes === false) {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            null,
	            'Balance: £',
	            parseFloat(this.props.data.amount).toFixed(2)
	          ),
	          notesElement,
	  ...
	  accClicked: function accClicked(e) {
	    e.preventDefault();
	  ...
	  notesClicked: function notesClicked(e) {
	    e.preventDefault();
	  ...
	  changeCurrentNote: function changeCurrentNote(e) {
	    this.setState({ currentNote: e.target.value });
	  },
	
	  handleNoteSubmit: function handleNoteSubmit(e) {
	    e.preventDefault();
